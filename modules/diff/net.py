...
class DiffNet(nn.Module):
    def __init__(self, in_dims=80):
        ...
        self.params = params = AttrDict(
            # Model params
            encoder_hidden=hparams["diff_decoder_args"]["wavenet"]["hidden_size"],
            residual_layers=hparams["diff_decoder_args"]["wavenet"]["residual_layers"],
            residual_channels=hparams["diff_decoder_args"]["wavenet"]["residual_channels"],
            dilation_cycle_length=hparams["diff_decoder_args"]["wavenet"]["dilation_cycle_length"],
        )
